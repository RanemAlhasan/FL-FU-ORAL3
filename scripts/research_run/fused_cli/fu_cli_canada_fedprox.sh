...
#SBATCH -J fu_cli_canada_fedprox
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/fused_cli/output_fu_cli_canada_fedprox_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/fused_cli/error_fu_cli_canada_fedprox_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
echo ""
echo "=== FUSED-CLI oral3, algorithm=fedprox, forget=Canada_Dataset ==="
...
python3 scripts/run_fu_cli_domain.py \
    ...
    --local_epoch 3 \
    --batch_size 16 \
    --run_id "fu_cli_fedprox_canada_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = fu_cli_fedprox_canada_oral_${SLURM_JOB_ID}"
