...
#SBATCH -J fused_cli_c10_fedbn
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/fused_cli/output_fused_cli_cifar10_fedbn_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/fused_cli/error_fused_cli_cifar10_fedbn_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# =============================================================================
# FUSED CIFAR-10 via the REAL paper method (CLI + sparse adapters), algorithm=fedbn.
...
echo ""
echo "=== FUSED-CLI CIFAR-10, algorithm=fedbn ==="
...
python3 scripts/run_fused_cli_cifar10.py \
    ...
    --run_id "fused_cli_fedbn_cifar10_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = fused_cli_fedbn_cifar10_${SLURM_JOB_ID}"
