...
#SBATCH -J fu_cli_canada_fedmoon
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/fused_cli/output_fu_cli_canada_fedmoon_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/fused_cli/error_fu_cli_canada_fedmoon_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# =============================================================================
# FUSED oral3 via the REAL paper method (CLI + sparse adapters), algorithm=fedmoon,
# forgetting Canada_Dataset. Source checkpoint is the plain-FedAvg Phase-1 run
...
echo ""
echo "=== FUSED-CLI oral3, algorithm=fedmoon, forget=Canada_Dataset ==="
...
python3 scripts/run_fu_cli_domain.py \
    ...
    --local_epoch 3 \
    --batch_size 16 \
    --run_id "fu_cli_fedmoon_canada_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = fu_cli_fedmoon_canada_oral_${SLURM_JOB_ID}"
