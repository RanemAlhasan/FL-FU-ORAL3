#!/bin/bash -l
#SBATCH -J ret_india_favg_wrs
#SBATCH -o output_retrain_india_fedavg_wrs_%j.txt
#SBATCH -e error_retrain_india_fedavg_wrs_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 16
#SBATCH --mem=64G
...
echo ""
echo "=== Exact retraining: FedAvg + WRS, forget India ==="
...
python3 scripts/run_retrain.py \
  ...
  --run_id "retrain_india_fedavg_wrs_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = retrain_india_fedavg_wrs_oral_${SLURM_JOB_ID}"