...
#SBATCH -J fu_cli_india_fedbn_bb
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/fused_cli_backbone/output_fu_cli_india_fedbn_bb_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/fused_cli_backbone/error_fu_cli_india_fedbn_bb_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# scripts/research_run/fused_cli/fu_cli_india_fedbn.sh.
#
# The original fu_cli_india_fedbn.sh always forks from the plain-FedAvg
...
echo ""
echo "=== FUSED-CLI oral3 (BACKBONE ablation), algorithm=fedbn, forget=India_Dataset ==="
...
python3 scripts/run_fu_cli_domain.py \
    ...
    --local_epoch 3 \
    --batch_size 16 \
    --run_id "fu_cli_fedbn_india_backbone_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = fu_cli_fedbn_india_backbone_oral_${SLURM_JOB_ID}"
