...
#SBATCH -J retrain_canada_fedmoon
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/output_retrain_canada_fedmoon_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/error_retrain_canada_fedmoon_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# =============================================================================
# CONTRIBUTION: Retrain-from-scratch baseline using FedMoon, excluding
# Canada_Dataset. Uses EXISTING run_retrain.py / Flower engine unchanged.
# =============================================================================
...
echo ""
echo "=== Phase 3: Retrain-from-scratch baseline (algorithm=FedMoon, exclude=Canada_Dataset) ==="

python3 scripts/run_retrain.py \
    --config configs/retrain_baseline.yaml \
    --set dataset_path="${DATASET_PATH}" \
    --set algorithm=FedMoon \
    --forget_client Canada_Dataset \
    --run_id "retrain_canada_fedmoon_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = retrain_canada_fedmoon_oral_${SLURM_JOB_ID}"
