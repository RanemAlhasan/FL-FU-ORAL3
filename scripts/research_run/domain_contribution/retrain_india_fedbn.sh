...
#SBATCH -J retrain_india_fedbn
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/output_retrain_india_fedbn_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/error_retrain_india_fedbn_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# algorithm, for a fair comparison against the fu_domain_india_fedbn
# run), excluding India_Dataset. Uses the EXISTING run_retrain.py /
...
echo ""
echo "=== Phase 3: Retrain-from-scratch baseline (algorithm=FedBN, exclude=India_Dataset) ==="
...
python3 scripts/run_retrain.py \
    ...
    --run_id "retrain_india_fedbn_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = retrain_india_fedbn_oral_${SLURM_JOB_ID}"
