...
#SBATCH -J fu_domain_india_fedbn
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/fu_domain/output_fu_domain_india_fedbn_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/fu_domain/error_fu_domain_india_fedbn_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# (fedbn) applied DURING the unlearning phase itself, forgetting India_Dataset.
...
echo ""
echo "=== FUSED unlearning, algorithm=fedbn, forget=India_Dataset ==="
...
python3 scripts/run_fu_lora_domain.py \
    ...
    --local_epoch 3 \
    --batch_size 16 \
    --run_id "fu_domain_fedbn_india_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = fu_domain_fedbn_india_oral_${SLURM_JOB_ID}"
