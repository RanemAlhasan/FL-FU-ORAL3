...
#SBATCH -J retrain_canada_fedprox
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/output_retrain_canada_fedprox_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/error_retrain_canada_fedprox_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# algorithm, for a fair comparison against the fu_domain_canada_fedprox
...
echo ""
echo "=== Phase 3: Retrain-from-scratch baseline (algorithm=FedProx, exclude=Canada_Dataset) ==="
...
python3 scripts/run_retrain.py \
    ...
    --run_id "retrain_canada_fedprox_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = retrain_canada_fedprox_oral_${SLURM_JOB_ID}"
