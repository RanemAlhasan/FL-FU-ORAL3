...
#SBATCH -J fu_domain_india_fedmoon
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/fu_domain/output_fu_domain_india_fedmoon_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/fu_domain/error_fu_domain_india_fedmoon_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# =============================================================================
# CONTRIBUTION: FUSED unlearning, algorithm=fedmoon, forgetting India_Dataset.
...
echo ""
echo "=== FUSED unlearning, algorithm=fedmoon, forget=India_Dataset ==="
...
python3 scripts/run_fu_lora_domain.py \
    ...
    --local_epoch 3 \
    --batch_size 16 \
    --run_id "fu_domain_fedmoon_india_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = fu_domain_fedmoon_india_oral_${SLURM_JOB_ID}"
