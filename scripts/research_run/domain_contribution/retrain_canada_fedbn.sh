...
#SBATCH -J retrain_canada_fedbn
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/output_retrain_canada_fedbn_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/error_retrain_canada_fedbn_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# =============================================================================
# CONTRIBUTION: Retrain-from-scratch baseline using FedBN (matched
# algorithm, for a fair comparison against the fu_domain_canada_fedbn
# run), excluding Canada_Dataset. Uses the EXISTING run_retrain.py /
# Flower engine unchanged -- FedBN support was already implemented and
...
echo ""
echo "=== Phase 3: Retrain-from-scratch baseline (algorithm=FedBN, exclude=Canada_Dataset) ==="
...
python3 scripts/run_retrain.py \
    ...
    --run_id "retrain_canada_fedbn_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = retrain_canada_fedbn_oral_${SLURM_JOB_ID}"
