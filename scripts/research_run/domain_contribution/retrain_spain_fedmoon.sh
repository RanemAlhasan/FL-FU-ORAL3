...
#SBATCH -J retrain_spain_fedmoon
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/output_retrain_spain_fedmoon_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/error_retrain_spain_fedmoon_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# Spain_Dataset. Uses EXISTING run_retrain.py / Flower engine unchanged.
# =============================================================================
...
echo ""
echo "=== Phase 3: Retrain-from-scratch baseline (algorithm=FedMoon, exclude=Spain_Dataset) ==="
...
python3 scripts/run_retrain.py \
    ...
    --run_id "retrain_spain_fedmoon_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = retrain_spain_fedmoon_oral_${SLURM_JOB_ID}"
