#!/bin/bash -l
#SBATCH -J fl_fedbn_global_wce
#SBATCH -o output_fl_fedbn_global_wce_%j.txt
#SBATCH -e error_fl_fedbn_global_wce_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 16
#SBATCH --mem=64G
...
python3 scripts/run_fl.py \
  ...
  --run_id "fl_fedbn_global_wce_oral_${SLURM_JOB_ID}"
