#!/bin/bash -l
#SBATCH -J fl_fedbn_local_cbce
#SBATCH -o output_fl_fedbn_local_cbce_%j.txt
#SBATCH -e error_fl_fedbn_local_cbce_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 16
#SBATCH --mem=64G
...
echo ""
echo "=== Class imbalance experiment: FedBN + standard CE + no sampler ===" 
python3 scripts/run_fl.py \
  ...
  --run_id "fl_fedbn_local_cbce_oral_${SLURM_JOB_ID}"
