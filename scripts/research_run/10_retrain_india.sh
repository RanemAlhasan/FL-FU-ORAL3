...
#SBATCH -J retrain_india_oral
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/output_retrain_india_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/retrain/error_retrain_india_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# =============================================================================
# Phase 3, Run 3/3: Retrain-from-scratch baseline, excluding India_Dataset.
# =============================================================================
...
echo ""
echo "=== Phase 3: Retrain-from-scratch baseline (exclude=India_Dataset, full scale) ==="
...
python3 scripts/run_retrain.py \
    ...
    --run_id "retrain_india_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = retrain_india_oral_${SLURM_JOB_ID}"