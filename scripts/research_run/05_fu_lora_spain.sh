...
#SBATCH -J fu_lora_spain_oral
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/fu_lora/output_fu_lora_spain_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/fu_lora/error_fu_lora_spain_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# =============================================================================
# Phase 2, Run 1/3: FUSED unlearning via LoRA, forgetting Spain_Dataset.
# =============================================================================
...
python3 scripts/run_fu_lora.py \
    ...
    --local_epoch 3 \
    --batch_size 16 \
    --run_id "fu_lora_spain_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = fu_lora_spain_oral_${SLURM_JOB_ID} (forked from ${SOURCE_RUN})"