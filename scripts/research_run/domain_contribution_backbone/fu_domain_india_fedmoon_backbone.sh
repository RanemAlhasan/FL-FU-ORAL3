...
#SBATCH -J fu_domain_india_fedmoon_bb
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/domain_contribution_backbone/output_fu_domain_india_fedmoon_bb_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/domain_contribution_backbone/error_fu_domain_india_fedmoon_bb_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 8
#SBATCH --mem 32G
...
# scripts/research_run/domain_contribution/fu_domain_india_fedmoon.sh.
#
# The original fu_domain_india_fedmoon.sh always forks from the plain-FedAvg
...
echo ""
echo "=== FUSED oral3 (BACKBONE ablation, LoRA), algorithm=fedmoon, forget=India_Dataset ==="
...
python3 scripts/run_fu_lora_domain.py \
    ...
    --local_epoch 3 \
    --batch_size 16 \
    --run_id "fu_domain_fedmoon_india_backbone_oral_${SLURM_JOB_ID}"

echo ""
echo "Done. run_id = fu_domain_fedmoon_india_backbone_oral_${SLURM_JOB_ID}"
