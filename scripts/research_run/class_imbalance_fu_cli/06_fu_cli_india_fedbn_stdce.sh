#!/bin/bash -l
#SBATCH -J fucli_fbn_in
#SBATCH -o /export/home/ralhasan/fl-fu-oral3/slurm_logs/class_imbalance_fu_cli/output_fucli_fbn_in_%j.txt
#SBATCH -e /export/home/ralhasan/fl-fu-oral3/slurm_logs/class_imbalance_fu_cli/error_fucli_fbn_in_%j.txt
#SBATCH -p gpu-all
#SBATCH --gres gpu:1
#SBATCH -c 16
#SBATCH --mem=64G
...
RUN_PREFIX="fu_cli_india_fedbn_stdce_oral"
